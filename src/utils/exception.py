...
class DataProcessingError(Enum):
    ...
    DATA_ARGUMENTATION_ERROR = "DATA_ARGUMENTATION_ERROR"
...
class DataArgumentationError(BaseDataProcessingException):
    """데이터 증강 예외"""
    def __init__(self, error: DataProcessingError.DATA_ARGUMENTATION_ERROR, status_code: int = 500):
        super().__init__(error, status_code=status_code)
